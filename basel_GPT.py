...
def query_message(
    ...
    If you have to give name of relevent article/chapter, use the following format: 
    [{Article}](https://www.bis.org/basel_framework/chapter/{The first 3 characters of Chapter article is in}/{The rest of the Chapter article is in}/)
    '''
